                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <!-- Calculate the total and add it to the QR code -->
                                            <c:set var="thumbnailUrl" value="${product.thumbnail}" />
                                            <c:set var="nameUrl" value="${product.name}" />
                                            <c:set var="priceUrl" value="${product.price}" />
                                            <c:set var="totalUrl" value="${total}" /> <!-- Add total value to the URL -->

                                            <!-- Now include the grand total in the QR code -->
                                            <c:set var="qrCodeUrl" value="${thumbnailUrl} ${nameUrl} ${priceUrl} Grand Total: ${totalUrl}" />
