                                    ...
                                    <div class="sidebar-widget-body m-t-10">
                                        <div class="price-range-holder">
                                            <form method="GET" action="ShopServlet">
                                                <span class="min-max">
                                                    <span class="pull-left">$<span id="min-price-display">200</span></span>
                                                    <span class="pull-right">$<span id="max-price-display">800</span></span>
                                                </span>

                                                <!-- Price slider range input -->
                                                <input type="range" id="minPrice" name="minPrice" min="0" max="1000" value="200" oninput="updatePriceDisplay()">
                                                <input type="range" id="maxPrice" name="maxPrice" min="0" max="1000" value="800" oninput="updatePriceDisplay()">
